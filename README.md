...
На старших курсах университета изучил основные методы построения и нормализации баз данных. Изучил синтаксис языка структурированных запросов PostgreSQL и написал своё приложение с использованием БД 🔑. Изучал программирование на языках Verilog и SystemVerilog, работу с ПЛИС, симулирование нетлистов, построение процессорных систем на базе NIOS II с использованием Eclipse C++. Написал пару проектов для регулирования движением перекрёстка на ПЛИС. Прошел курс "Основы работы с Git" от Яндекса 📈.
